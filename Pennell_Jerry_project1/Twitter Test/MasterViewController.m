...
//    ViewController *friendsViewController = [[ViewController alloc] initWithNibName:@"ViewController" bundle:nil];
//    
//    
//    UITabBarController *tabBarController = [[UITabBarController alloc] init];
//    
//    [tabBarController setViewControllers:[NSArray arrayWithObjects:friendsViewController, nil]];
//    
